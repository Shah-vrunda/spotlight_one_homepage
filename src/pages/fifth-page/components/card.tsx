...
const PhotoCard = ({
  ...
  return (
    <>
      {!hoverState && (
        <div
          className="flex flex-col bg-[#FFFAEB] overflow-hidden h-[90%] md:h-[50%] lg:h-[65vh] w-full md:w-[70%] lg:w-[50%] xl:w-[40%] mx-auto my-4 relative hover:scale-105 hover:animate-fade-left hover:animate-duration-[180ms] transition-transform duration-700 ease-in-out delay-150"
        ...
        >
          ...
          <div className="p-1 md:p-2 pb-0 flex-grow flex flex-col justify-center">
            <h2 className="text-[#270530] text-md  md:text-xl lg:text-2xl font-medium">
              {title}
            </h2>
      ...
      {hoverState && deviceType === "lg" && (
        <div
          data-aos="fade-out"
          className={`relative bg-cover bg-center md:h-[45vh] lg:h-[65vh] w-full mx-auto my-4 transition-all duration-700 ease-in-out opacity-80 animate-fadeIn ${
            photoName === "cd"
